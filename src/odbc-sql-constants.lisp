...
;;;; TODO:
(defmacro SQL_SUCCEEDED (rc)
  ((rc)&(~1))==0)

;;;;** Flags for null-terminated string
(defconstant SQL_NTS -3)
(defconstant SQL_NTSL -3L)
...
;;;;*** null handle used in place of parent handle when allocating HENV
  (defconstant SQL_NULL_HANDLE 0L))
...
;;#if (ODBCVER >= 0x0200)
(defconstant SQL_AT_ADD_COLUMN 0x00000001L)
(defconstant SQL_AT_DROP_COLUMN 0x00000002L)
;;#endif /* ODBCVER >= 0x0200 */

#-odbc2
(defconstant SQL_AT_ADD_CONSTRAINT 0x00000008L)
...
(defconstant SQL_FD_FETCH_NEXT 0x00000001L)
(defconstant SQL_FD_FETCH_FIRST 0x00000002L)
(defconstant SQL_FD_FETCH_LAST 0x00000004L)
(defconstant SQL_FD_FETCH_PRIOR 0x00000008L)
(defconstant SQL_FD_FETCH_ABSOLUTE 0x00000010L)
(defconstant SQL_FD_FETCH_RELATIVE 0x00000020L)

;;;;** SQL_GETDATA_EXTENSIONS bitmasks
(defconstant SQL_GD_ANY_COLUMN 0x00000001L)
(defconstant SQL_GD_ANY_ORDER 0x00000002L)
...
;;#if (ODBCVER >= 0x0201)
(defconstant SQL_OJ_LEFT 0x00000001L)
(defconstant SQL_OJ_RIGHT 0x00000002L)
(defconstant SQL_OJ_FULL 0x00000004L)
(defconstant SQL_OJ_NESTED 0x00000008L)
(defconstant SQL_OJ_NOT_ORDERED 0x00000010L)
(defconstant SQL_OJ_INNER 0x00000020L)
(defconstant SQL_OJ_ALL_COMPARISON_OPS 0x00000040L)
;;#endif

;;;;** SQL_SCROLL_CONCURRENCY bitmasks
(defconstant SQL_SCCO_READ_ONLY 0x00000001L)
(defconstant SQL_SCCO_LOCK 0x00000002L)
(defconstant SQL_SCCO_OPT_ROWVER 0x00000004L)
(defconstant SQL_SCCO_OPT_VALUES 0x00000008L)
...
;;;;** values for SQL_ATTR_CONNECTION_POOLING
  (defconstant SQL_CP_OFF 0UL)
  (defconstant SQL_CP_ONE_PER_DRIVER 1UL)
  (defconstant SQL_CP_ONE_PER_HENV 2UL)
  (defconstant SQL_CP_DEFAULT SQL_CP_OFF)

;;;;** values for SQL_ATTR_CP_MATCH
  (defconstant SQL_CP_STRICT_MATCH 0UL)
  (defconstant SQL_CP_RELAXED_MATCH 1UL)
  (defconstant SQL_CP_MATCH_DEFAULT SQL_CP_STRICT_MATCH)

;;;;** values for SQL_ATTR_ODBC_VERSION
  (defconstant SQL_OV_ODBC2 2UL)
  (defconstant SQL_OV_ODBC3 3UL)
;;;; new values for SQL_ATTR_ODBC_VERSION 
;;;; From ODBC 3.8 onwards, we should use <major version> * 100 + <minor version>
  (defconstant SQL_OV_ODBC3_80 380UL))
...
(defconstant SQL_MODE_READ_WRITE 0UL)
(defconstant SQL_MODE_READ_ONLY 1UL)
(defconstant SQL_MODE_DEFAULT SQL_MODE_READ_WRITE)

;;;;** SQL_AUTOCOMMIT options
(defconstant SQL_AUTOCOMMIT_OFF 0UL)
(defconstant SQL_AUTOCOMMIT_ON 1UL)
(defconstant SQL_AUTOCOMMIT_DEFAULT SQL_AUTOCOMMIT_ON)

;;;;** SQL_LOGIN_TIMEOUT options
(defconstant SQL_LOGIN_TIMEOUT_DEFAULT 15UL)

;;;;** SQL_OPT_TRACE options
(defconstant SQL_OPT_TRACE_OFF 0UL)
(defconstant SQL_OPT_TRACE_ON 1UL)
(defconstant SQL_OPT_TRACE_DEFAULT SQL_OPT_TRACE_OFF)
(defconstant SQL_OPT_TRACE_FILE_DEFAULT "\\SQL.LOG")

;;;;** SQL_ODBC_CURSORS options
(defconstant SQL_CUR_USE_IF_NEEDED 0UL)
(defconstant SQL_CUR_USE_ODBC 1UL)
(defconstant SQL_CUR_USE_DRIVER 2UL)
(defconstant SQL_CUR_DEFAULT SQL_CUR_USE_DRIVER)

#-odbc2
(progn
;;;;** values for SQL_ATTR_DISCONNECT_BEHAVIOR
  (defconstant SQL_DB_RETURN_TO_POOL 0UL)
  (defconstant SQL_DB_DISCONNECT 1UL)
  (defconstant SQL_DB_DEFAULT SQL_DB_RETURN_TO_POOL)

;;;;** values for SQL_ATTR_ENLIST_IN_DTC
  (defconstant SQL_DTC_DONE 0L))

;;;;** values for SQL_ATTR_CONNECTION_DEAD
(defconstant SQL_CD_TRUE 1L);; Connection is closed/dead
(defconstant SQL_CD_FALSE 0L);; Connection is open/available

;;;;** values for SQL_ATTR_ANSI_APP
#-odbc2
(progn
  (defconstant SQL_AA_TRUE 1L);; the application is an ANSI app
  (defconstant SQL_AA_FALSE 0L);; the application is a Unicode app

;;;;** values for SQL_ATTR_RESET_CONNECTION
  ;;#if (ODBCVER >= 0x0380)
  (defconstant SQL_RESET_CONNECTION_YES 1UL)
  ;;#endif

;;;;** values for SQL_ATTR_ASYNC_DBC_FUNCTIONS_ENABLE
  ;;#if (ODBCVER >= 0x0380)
  (defconstant SQL_ASYNC_DBC_ENABLE_ON 1UL)
  (defconstant SQL_ASYNC_DBC_ENABLE_OFF 0UL)
...
;;;;** the value of SQL_ATTR_PARAM_BIND_TYPE
  (defconstant SQL_PARAM_BIND_BY_COLUMN 0UL)
...
(progn
  ...
  (defconstant SQL_UB_VARIABLE 2UL)
...
;;;; SQL_DRIVER_C_TYPE_BASE+1, SQL_DRIVER_C_TYPE_BASE+2, etc.
  ;;#if (ODBCVER >= 0x380)
  (defconstant SQL_DRIVER_C_TYPE_BASE 0x4000)
  ;;#endif
...
;;;; as future versions of the DM may enforce these constraints
  ;;#if (ODBCVER >= 0x380)
  (defconstant SQL_DRIVER_SQL_TYPE_BASE 0x4000)
  (defconstant SQL_DRIVER_DESC_FIELD_BASE 0x4000)
  (defconstant SQL_DRIVER_DIAG_FIELD_BASE 0x4000)
  (defconstant SQL_DRIVER_INFO_TYPE_BASE 0x4000)
  (defconstant SQL_DRIVER_CONN_ATTR_BASE 0x00004000  // 32-bit)
  (defconstant SQL_DRIVER_STMT_ATTR_BASE 0x00004000  // 32-bit)
  ;;#endif
...
(defconstant SQL_LEN_BINARY_ATTR(length) (-(length)+SQL_LEN_BINARY_ATTR_OFFSET))

;;;;/* Defines used by Driver Manager when mapping SQLSetParam to SQLBindParameter
;;;;*/
(defconstant SQL_PARAM_TYPE_DEFAULT SQL_PARAM_INPUT_OUTPUT)
(defconstant SQL_SETPARAM_VALUE_MAX (-1L))
...
;;;;*/
  (defconstant SQL_AT_ADD_COLUMN_SINGLE 0x00000020L)
  (defconstant SQL_AT_ADD_COLUMN_DEFAULT 0x00000040L)
  (defconstant SQL_AT_ADD_COLUMN_COLLATION 0x00000080L)
  (defconstant SQL_AT_SET_COLUMN_DEFAULT 0x00000100L)
  (defconstant SQL_AT_DROP_COLUMN_DEFAULT 0x00000200L)
  (defconstant SQL_AT_DROP_COLUMN_CASCADE 0x00000400L)
  (defconstant SQL_AT_DROP_COLUMN_RESTRICT 0x00000800L)
  (defconstant SQL_AT_ADD_TABLE_CONSTRAINT 0x00001000L)
  (defconstant SQL_AT_DROP_TABLE_CONSTRAINT_CASCADE 0x00002000L)
  (defconstant SQL_AT_DROP_TABLE_CONSTRAINT_RESTRICT 0x00004000L)
  (defconstant SQL_AT_CONSTRAINT_NAME_DEFINITION 0x00008000L)
  (defconstant SQL_AT_CONSTRAINT_INITIALLY_DEFERRED 0x00010000L)
  (defconstant SQL_AT_CONSTRAINT_INITIALLY_IMMEDIATE 0x00020000L)
  (defconstant SQL_AT_CONSTRAINT_DEFERRABLE 0x00040000L)
  (defconstant SQL_AT_CONSTRAINT_NON_DEFERRABLE 0x00080000L))

;;;;** SQL_CONVERT_*  return value bitmasks
(defconstant SQL_CVT_CHAR 0x00000001L)
(defconstant SQL_CVT_NUMERIC 0x00000002L)
(defconstant SQL_CVT_DECIMAL 0x00000004L)
(defconstant SQL_CVT_INTEGER 0x00000008L)
(defconstant SQL_CVT_SMALLINT 0x00000010L)
(defconstant SQL_CVT_FLOAT 0x00000020L)
(defconstant SQL_CVT_REAL 0x00000040L)
(defconstant SQL_CVT_DOUBLE 0x00000080L)
(defconstant SQL_CVT_VARCHAR 0x00000100L)
(defconstant SQL_CVT_LONGVARCHAR 0x00000200L)
(defconstant SQL_CVT_BINARY 0x00000400L)
(defconstant SQL_CVT_VARBINARY 0x00000800L)
(defconstant SQL_CVT_BIT 0x00001000L)
(defconstant SQL_CVT_TINYINT 0x00002000L)
(defconstant SQL_CVT_BIGINT 0x00004000L)
(defconstant SQL_CVT_DATE 0x00008000L)
(defconstant SQL_CVT_TIME 0x00010000L)
(defconstant SQL_CVT_TIMESTAMP 0x00020000L)
(defconstant SQL_CVT_LONGVARBINARY 0x00040000L)
#-odbc2
(progn
  (defconstant SQL_CVT_INTERVAL_YEAR_MONTH 0x00080000L)
  (defconstant SQL_CVT_INTERVAL_DAY_TIME 0x00100000L)
  (defconstant SQL_CVT_WCHAR 0x00200000L)
  (defconstant SQL_CVT_WLONGVARCHAR 0x00400000L)
  (defconstant SQL_CVT_WVARCHAR 0x00800000L)
  (defconstant SQL_CVT_GUID 0x01000000L))

;;;;** SQL_CONVERT_FUNCTIONS functions
(defconstant SQL_FN_CVT_CONVERT 0x00000001L)
#-odbc2
(defconstant SQL_FN_CVT_CAST 0x00000002L)

;;;;** SQL_STRING_FUNCTIONS functions
(defconstant SQL_FN_STR_CONCAT 0x00000001L)
(defconstant SQL_FN_STR_INSERT 0x00000002L)
(defconstant SQL_FN_STR_LEFT 0x00000004L)
(defconstant SQL_FN_STR_LTRIM 0x00000008L)
(defconstant SQL_FN_STR_LENGTH 0x00000010L)
(defconstant SQL_FN_STR_LOCATE 0x00000020L)
(defconstant SQL_FN_STR_LCASE 0x00000040L)
(defconstant SQL_FN_STR_REPEAT 0x00000080L)
(defconstant SQL_FN_STR_REPLACE 0x00000100L)
(defconstant SQL_FN_STR_RIGHT 0x00000200L)
(defconstant SQL_FN_STR_RTRIM 0x00000400L)
(defconstant SQL_FN_STR_SUBSTRING 0x00000800L)
(defconstant SQL_FN_STR_UCASE 0x00001000L)
(defconstant SQL_FN_STR_ASCII 0x00002000L)
(defconstant SQL_FN_STR_CHAR 0x00004000L)
(defconstant SQL_FN_STR_DIFFERENCE 0x00008000L)
(defconstant SQL_FN_STR_LOCATE_2 0x00010000L)
(defconstant SQL_FN_STR_SOUNDEX 0x00020000L)
(defconstant SQL_FN_STR_SPACE 0x00040000L)
#-odbc2
(progn
  (defconstant SQL_FN_STR_BIT_LENGTH 0x00080000L)
  (defconstant SQL_FN_STR_CHAR_LENGTH 0x00100000L)
  (defconstant SQL_FN_STR_CHARACTER_LENGTH 0x00200000L)
  (defconstant SQL_FN_STR_OCTET_LENGTH 0x00400000L)
  (defconstant SQL_FN_STR_POSITION 0x00800000L)

;;;;** SQL_SQL92_STRING_FUNCTIONS
  (defconstant SQL_SSF_CONVERT 0x00000001L)
  (defconstant SQL_SSF_LOWER 0x00000002L)
  (defconstant SQL_SSF_UPPER 0x00000004L)
  (defconstant SQL_SSF_SUBSTRING 0x00000008L)
  (defconstant SQL_SSF_TRANSLATE 0x00000010L)
  (defconstant SQL_SSF_TRIM_BOTH 0x00000020L)
  (defconstant SQL_SSF_TRIM_LEADING 0x00000040L)
  (defconstant SQL_SSF_TRIM_TRAILING 0x00000080L))

;;;;** SQL_NUMERIC_FUNCTIONS functions
(defconstant SQL_FN_NUM_ABS 0x00000001L)
(defconstant SQL_FN_NUM_ACOS 0x00000002L)
(defconstant SQL_FN_NUM_ASIN 0x00000004L)
(defconstant SQL_FN_NUM_ATAN 0x00000008L)
(defconstant SQL_FN_NUM_ATAN2 0x00000010L)
(defconstant SQL_FN_NUM_CEILING 0x00000020L)
(defconstant SQL_FN_NUM_COS 0x00000040L)
(defconstant SQL_FN_NUM_COT 0x00000080L)
(defconstant SQL_FN_NUM_EXP 0x00000100L)
(defconstant SQL_FN_NUM_FLOOR 0x00000200L)
(defconstant SQL_FN_NUM_LOG 0x00000400L)
(defconstant SQL_FN_NUM_MOD 0x00000800L)
(defconstant SQL_FN_NUM_SIGN 0x00001000L)
(defconstant SQL_FN_NUM_SIN 0x00002000L)
(defconstant SQL_FN_NUM_SQRT 0x00004000L)
(defconstant SQL_FN_NUM_TAN 0x00008000L)
(defconstant SQL_FN_NUM_PI 0x00010000L)
(defconstant SQL_FN_NUM_RAND 0x00020000L)
(defconstant SQL_FN_NUM_DEGREES 0x00040000L)
(defconstant SQL_FN_NUM_LOG10 0x00080000L)
(defconstant SQL_FN_NUM_POWER 0x00100000L)
(defconstant SQL_FN_NUM_RADIANS 0x00200000L)
(defconstant SQL_FN_NUM_ROUND 0x00400000L)
(defconstant SQL_FN_NUM_TRUNCATE 0x00800000L)

;;;;** SQL_SQL92_NUMERIC_VALUE_FUNCTIONS
#-odbc2
(progn
  (defconstant SQL_SNVF_BIT_LENGTH 0x00000001L)
  (defconstant SQL_SNVF_CHAR_LENGTH 0x00000002L)
  (defconstant SQL_SNVF_CHARACTER_LENGTH 0x00000004L)
  (defconstant SQL_SNVF_EXTRACT 0x00000008L)
  (defconstant SQL_SNVF_OCTET_LENGTH 0x00000010L)
  (defconstant SQL_SNVF_POSITION 0x00000020L))

;;;;** SQL_TIMEDATE_FUNCTIONS functions
(defconstant SQL_FN_TD_NOW 0x00000001L)
(defconstant SQL_FN_TD_CURDATE 0x00000002L)
(defconstant SQL_FN_TD_DAYOFMONTH 0x00000004L)
(defconstant SQL_FN_TD_DAYOFWEEK 0x00000008L)
(defconstant SQL_FN_TD_DAYOFYEAR 0x00000010L)
(defconstant SQL_FN_TD_MONTH 0x00000020L)
(defconstant SQL_FN_TD_QUARTER 0x00000040L)
(defconstant SQL_FN_TD_WEEK 0x00000080L)
(defconstant SQL_FN_TD_YEAR 0x00000100L)
(defconstant SQL_FN_TD_CURTIME 0x00000200L)
(defconstant SQL_FN_TD_HOUR 0x00000400L)
(defconstant SQL_FN_TD_MINUTE 0x00000800L)
(defconstant SQL_FN_TD_SECOND 0x00001000L)
(defconstant SQL_FN_TD_TIMESTAMPADD 0x00002000L)
(defconstant SQL_FN_TD_TIMESTAMPDIFF 0x00004000L)
(defconstant SQL_FN_TD_DAYNAME 0x00008000L)
(defconstant SQL_FN_TD_MONTHNAME 0x00010000L)
#-odbc2
(progn
  (defconstant SQL_FN_TD_CURRENT_DATE 0x00020000L)
  (defconstant SQL_FN_TD_CURRENT_TIME 0x00040000L)
  (defconstant SQL_FN_TD_CURRENT_TIMESTAMP 0x00080000L)
  (defconstant SQL_FN_TD_EXTRACT 0x00100000L)

;;;;** SQL_SQL92_DATETIME_FUNCTIONS
  (defconstant SQL_SDF_CURRENT_DATE 0x00000001L)
  (defconstant SQL_SDF_CURRENT_TIME 0x00000002L)
  (defconstant SQL_SDF_CURRENT_TIMESTAMP 0x00000004L))

;;;;** SQL_SYSTEM_FUNCTIONS functions
(defconstant SQL_FN_SYS_USERNAME 0x00000001L)
(defconstant SQL_FN_SYS_DBNAME 0x00000002L)
(defconstant SQL_FN_SYS_IFNULL 0x00000004L)

;;;;** SQL_TIMEDATE_ADD_INTERVALS and SQL_TIMEDATE_DIFF_INTERVALS functions
(defconstant SQL_FN_TSI_FRAC_SECOND 0x00000001L)
(defconstant SQL_FN_TSI_SECOND 0x00000002L)
(defconstant SQL_FN_TSI_MINUTE 0x00000004L)
(defconstant SQL_FN_TSI_HOUR 0x00000008L)
(defconstant SQL_FN_TSI_DAY 0x00000010L)
(defconstant SQL_FN_TSI_WEEK 0x00000020L)
(defconstant SQL_FN_TSI_MONTH 0x00000040L)
(defconstant SQL_FN_TSI_QUARTER 0x00000080L)
(defconstant SQL_FN_TSI_YEAR 0x00000100L)
...
;;;;** supported SQLFetchScroll FetchOrientation's
  (defconstant SQL_CA1_NEXT 0x00000001L)
  (defconstant SQL_CA1_ABSOLUTE 0x00000002L)
  (defconstant SQL_CA1_RELATIVE 0x00000004L)
  (defconstant SQL_CA1_BOOKMARK 0x00000008L)

;;;;** supported SQLSetPos LockType's
  (defconstant SQL_CA1_LOCK_NO_CHANGE 0x00000040L)
  (defconstant SQL_CA1_LOCK_EXCLUSIVE 0x00000080L)
  (defconstant SQL_CA1_LOCK_UNLOCK 0x00000100L)

;;;;** supported SQLSetPos Operations
  (defconstant SQL_CA1_POS_POSITION 0x00000200L)
  (defconstant SQL_CA1_POS_UPDATE 0x00000400L)
  (defconstant SQL_CA1_POS_DELETE 0x00000800L)
  (defconstant SQL_CA1_POS_REFRESH 0x00001000L)

;;;;** positioned updates and deletes
  (defconstant SQL_CA1_POSITIONED_UPDATE 0x00002000L)
  (defconstant SQL_CA1_POSITIONED_DELETE 0x00004000L)
  (defconstant SQL_CA1_SELECT_FOR_UPDATE 0x00008000L)

;;;;** supported SQLBulkOperations operations
  (defconstant SQL_CA1_BULK_ADD 0x00010000L)
  (defconstant SQL_CA1_BULK_UPDATE_BY_BOOKMARK 0x00020000L)
  (defconstant SQL_CA1_BULK_DELETE_BY_BOOKMARK 0x00040000L)
  (defconstant SQL_CA1_BULK_FETCH_BY_BOOKMARK 0x00080000L)
...
;;;;** supported values for SQL_ATTR_SCROLL_CONCURRENCY
  (defconstant SQL_CA2_READ_ONLY_CONCURRENCY 0x00000001L)
  (defconstant SQL_CA2_LOCK_CONCURRENCY 0x00000002L)
  (defconstant SQL_CA2_OPT_ROWVER_CONCURRENCY 0x00000004L)
  (defconstant SQL_CA2_OPT_VALUES_CONCURRENCY 0x00000008L)

;;;;** sensitivity of the cursor to its own inserts, deletes, and updates
  (defconstant SQL_CA2_SENSITIVITY_ADDITIONS 0x00000010L)
  (defconstant SQL_CA2_SENSITIVITY_DELETIONS 0x00000020L)
  (defconstant SQL_CA2_SENSITIVITY_UPDATES 0x00000040L)

;;;;** semantics of SQL_ATTR_MAX_ROWS
  (defconstant SQL_CA2_MAX_ROWS_SELECT 0x00000080L)
  (defconstant SQL_CA2_MAX_ROWS_INSERT 0x00000100L)
  (defconstant SQL_CA2_MAX_ROWS_DELETE 0x00000200L)
  (defconstant SQL_CA2_MAX_ROWS_UPDATE 0x00000400L)
  (defconstant SQL_CA2_MAX_ROWS_CATALOG 0x00000800L)
  #+ (or)
...
;;;;** semantics of SQL_DIAG_CURSOR_ROW_COUNT
  (defconstant SQL_CA2_CRC_EXACT 0x00001000L)
  (defconstant SQL_CA2_CRC_APPROXIMATE 0x00002000L)

;;;;** the kinds of positioned statements that can be simulated
  (defconstant SQL_CA2_SIMULATE_NON_UNIQUE 0x00004000L)
  (defconstant SQL_CA2_SIMULATE_TRY_UNIQUE 0x00008000L)
  (defconstant SQL_CA2_SIMULATE_UNIQUE 0x00010000L))

;;;;** SQL_ODBC_API_CONFORMANCE values
(defconstant SQL_OAC_NONE 0x0000)
(defconstant SQL_OAC_LEVEL1 0x0001)
(defconstant SQL_OAC_LEVEL2 0x0002)

;;;;** SQL_ODBC_SAG_CLI_CONFORMANCE values
(defconstant SQL_OSCC_NOT_COMPLIANT 0x0000)
(defconstant SQL_OSCC_COMPLIANT 0x0001)

;;;;** SQL_ODBC_SQL_CONFORMANCE values
(defconstant SQL_OSC_MINIMUM 0x0000)
(defconstant SQL_OSC_CORE 0x0001)
(defconstant SQL_OSC_EXTENDED 0x0002)

;;;;** SQL_CONCAT_NULL_BEHAVIOR values
(defconstant SQL_CB_NULL 0x0000)
(defconstant SQL_CB_NON_NULL 0x0001)

;;;;** SQL_SCROLL_OPTIONS masks
(defconstant SQL_SO_FORWARD_ONLY 0x00000001L)
(defconstant SQL_SO_KEYSET_DRIVEN 0x00000002L)
(defconstant SQL_SO_DYNAMIC 0x00000004L)
(defconstant SQL_SO_MIXED 0x00000008L)
(defconstant SQL_SO_STATIC 0x00000010L)

;;;;** SQL_FETCH_DIRECTION masks

;;;;/* SQL_FETCH_RESUME is no longer supported
;;;;(defconstant SQL_FD_FETCH_RESUME 0x00000040L)
;;;;*/
(defconstant SQL_FD_FETCH_BOOKMARK 0x00000080L)

;;;;** SQL_TXN_ISOLATION_OPTION masks
;;;;/* SQL_TXN_VERSIONING is no longer supported
;;;;(defconstant SQL_TXN_VERSIONING 0x00000010L)
;;;;*/

;;;;** SQL_CORRELATION_NAME values
(defconstant SQL_CN_NONE 0x0000)
(defconstant SQL_CN_DIFFERENT 0x0001)
(defconstant SQL_CN_ANY 0x0002)

;;;;** SQL_NON_NULLABLE_COLUMNS values
(defconstant SQL_NNC_NULL 0x0000)
(defconstant SQL_NNC_NON_NULL 0x0001)

;;;;** SQL_NULL_COLLATION values
(defconstant SQL_NC_START 0x0002)
(defconstant SQL_NC_END 0x0004)

;;;;** SQL_FILE_USAGE values
(defconstant SQL_FILE_NOT_SUPPORTED 0x0000)
(defconstant SQL_FILE_TABLE 0x0001)
(defconstant SQL_FILE_QUALIFIER 0x0002)
(defconstant SQL_FILE_CATALOG SQL_FILE_QUALIFIER  // ODBC 3.0)


;;;;** SQL_GETDATA_EXTENSIONS values
(defconstant SQL_GD_BLOCK 0x00000004L)
(defconstant SQL_GD_BOUND 0x00000008L)
#-odbc2
;;#if (ODBCVER >= 0x0380)
(defconstant SQL_GD_OUTPUT_PARAMS 0x00000010L)
;;#endif

;;;;** SQL_POSITIONED_STATEMENTS masks
(defconstant SQL_PS_POSITIONED_DELETE 0x00000001L)
(defconstant SQL_PS_POSITIONED_UPDATE 0x00000002L)
(defconstant SQL_PS_SELECT_FOR_UPDATE 0x00000004L)

;;;;** SQL_GROUP_BY values
(defconstant SQL_GB_NOT_SUPPORTED 0x0000)
(defconstant SQL_GB_GROUP_BY_EQUALS_SELECT 0x0001)
(defconstant SQL_GB_GROUP_BY_CONTAINS_SELECT 0x0002)
(defconstant SQL_GB_NO_RELATION 0x0003)
#-odbc2
(defconstant SQL_GB_COLLATE 0x0004)

;;;;** SQL_OWNER_USAGE masks
(defconstant SQL_OU_DML_STATEMENTS 0x00000001L)
(defconstant SQL_OU_PROCEDURE_INVOCATION 0x00000002L)
(defconstant SQL_OU_TABLE_DEFINITION 0x00000004L)
(defconstant SQL_OU_INDEX_DEFINITION 0x00000008L)
(defconstant SQL_OU_PRIVILEGE_DEFINITION 0x00000010L)
...
(defconstant SQL_QU_DML_STATEMENTS 0x00000001L)
(defconstant SQL_QU_PROCEDURE_INVOCATION 0x00000002L)
(defconstant SQL_QU_TABLE_DEFINITION 0x00000004L)
(defconstant SQL_QU_INDEX_DEFINITION 0x00000008L)
(defconstant SQL_QU_PRIVILEGE_DEFINITION 0x00000010L)
...
(defconstant SQL_SQ_COMPARISON 0x00000001L)
(defconstant SQL_SQ_EXISTS 0x00000002L)
(defconstant SQL_SQ_IN 0x00000004L)
(defconstant SQL_SQ_QUANTIFIED 0x00000008L)
(defconstant SQL_SQ_CORRELATED_SUBQUERIES 0x00000010L)

;;;;** SQL_UNION masks
(defconstant SQL_U_UNION 0x00000001L)
(defconstant SQL_U_UNION_ALL 0x00000002L)

;;;;** SQL_BOOKMARK_PERSISTENCE values
(defconstant SQL_BP_CLOSE 0x00000001L)
(defconstant SQL_BP_DELETE 0x00000002L)
(defconstant SQL_BP_DROP 0x00000004L)
(defconstant SQL_BP_TRANSACTION 0x00000008L)
(defconstant SQL_BP_UPDATE 0x00000010L)
(defconstant SQL_BP_OTHER_HSTMT 0x00000020L)
(defconstant SQL_BP_SCROLL 0x00000040L)

;;;;** SQL_STATIC_SENSITIVITY values
(defconstant SQL_SS_ADDITIONS 0x00000001L)
(defconstant SQL_SS_DELETIONS 0x00000002L)
(defconstant SQL_SS_UPDATES 0x00000004L)

;;;;** SQL_VIEW values
(defconstant SQL_CV_CREATE_VIEW 0x00000001L)
(defconstant SQL_CV_CHECK_OPTION 0x00000002L)
(defconstant SQL_CV_CASCADED 0x00000004L)
(defconstant SQL_CV_LOCAL 0x00000008L)

;;;;** SQL_LOCK_TYPES masks
(defconstant SQL_LCK_NO_CHANGE 0x00000001L)
(defconstant SQL_LCK_EXCLUSIVE 0x00000002L)
(defconstant SQL_LCK_UNLOCK 0x00000004L)

;;;;** SQL_POS_OPERATIONS masks
(defconstant SQL_POS_POSITION 0x00000001L)
(defconstant SQL_POS_REFRESH 0x00000002L)
(defconstant SQL_POS_UPDATE 0x00000004L)
(defconstant SQL_POS_DELETE 0x00000008L)
(defconstant SQL_POS_ADD 0x00000010L)

;;;;** SQL_QUALIFIER_LOCATION values
(defconstant SQL_QL_START 0x0001)
(defconstant SQL_QL_END 0x0002)

;;;;** Here start return values for ODBC 3.0 SQLGetInfo
#-odbc2
(progn
;;;;** SQL_AGGREGATE_FUNCTIONS bitmasks
  (defconstant SQL_AF_AVG 0x00000001L)
  (defconstant SQL_AF_COUNT 0x00000002L)
  (defconstant SQL_AF_MAX 0x00000004L)
  (defconstant SQL_AF_MIN 0x00000008L)
  (defconstant SQL_AF_SUM 0x00000010L)
  (defconstant SQL_AF_DISTINCT 0x00000020L)
  (defconstant SQL_AF_ALL 0x00000040L)

;;;;** SQL_SQL_CONFORMANCE bit masks
  (defconstant SQL_SC_SQL92_ENTRY 0x00000001L)
  (defconstant SQL_SC_FIPS127_2_TRANSITIONAL 0x00000002L)
  (defconstant SQL_SC_SQL92_INTERMEDIATE 0x00000004L)
  (defconstant SQL_SC_SQL92_FULL 0x00000008L)

;;;;** SQL_DATETIME_LITERALS masks
  (defconstant SQL_DL_SQL92_DATE 0x00000001L)
  (defconstant SQL_DL_SQL92_TIME 0x00000002L)
  (defconstant SQL_DL_SQL92_TIMESTAMP 0x00000004L)
  (defconstant SQL_DL_SQL92_INTERVAL_YEAR 0x00000008L)
  (defconstant SQL_DL_SQL92_INTERVAL_MONTH 0x00000010L)
  (defconstant SQL_DL_SQL92_INTERVAL_DAY 0x00000020L)
  (defconstant SQL_DL_SQL92_INTERVAL_HOUR 0x00000040L)
  (defconstant SQL_DL_SQL92_INTERVAL_MINUTE 0x00000080L)
  (defconstant SQL_DL_SQL92_INTERVAL_SECOND 0x00000100L)
  (defconstant SQL_DL_SQL92_INTERVAL_YEAR_TO_MONTH 0x00000200L)
  (defconstant SQL_DL_SQL92_INTERVAL_DAY_TO_HOUR 0x00000400L)
  (defconstant SQL_DL_SQL92_INTERVAL_DAY_TO_MINUTE 0x00000800L)
  (defconstant SQL_DL_SQL92_INTERVAL_DAY_TO_SECOND 0x00001000L)
  (defconstant SQL_DL_SQL92_INTERVAL_HOUR_TO_MINUTE 0x00002000L)
  (defconstant SQL_DL_SQL92_INTERVAL_HOUR_TO_SECOND 0x00004000L)
  (defconstant SQL_DL_SQL92_INTERVAL_MINUTE_TO_SECOND 0x00008000L)
...
;;;;** values for SQL_BATCH_ROW_COUNT
  (defconstant SQL_BRC_PROCEDURES 0x0000001)
  (defconstant SQL_BRC_EXPLICIT 0x0000002)
  (defconstant SQL_BRC_ROLLED_UP 0x0000004)

;;;;** bitmasks for SQL_BATCH_SUPPORT
  (defconstant SQL_BS_SELECT_EXPLICIT 0x00000001L)
  (defconstant SQL_BS_ROW_COUNT_EXPLICIT 0x00000002L)
  (defconstant SQL_BS_SELECT_PROC 0x00000004L)
  (defconstant SQL_BS_ROW_COUNT_PROC 0x00000008L)
...
;;;;** Bitmasks for SQL_INDEX_KEYWORDS
  (defconstant SQL_IK_NONE 0x00000000L)
  (defconstant SQL_IK_ASC 0x00000001L)
  (defconstant SQL_IK_DESC 0x00000002L)
  (defconstant SQL_IK_ALL (bit-ior SQL_IK_ASC SQL_IK_DESC))

;;;;** Bitmasks for SQL_INFO_SCHEMA_VIEWS

  (defconstant SQL_ISV_ASSERTIONS 0x00000001L)
  (defconstant SQL_ISV_CHARACTER_SETS 0x00000002L)
  (defconstant SQL_ISV_CHECK_CONSTRAINTS 0x00000004L)
  (defconstant SQL_ISV_COLLATIONS 0x00000008L)
  (defconstant SQL_ISV_COLUMN_DOMAIN_USAGE 0x00000010L)
  (defconstant SQL_ISV_COLUMN_PRIVILEGES 0x00000020L)
  (defconstant SQL_ISV_COLUMNS 0x00000040L)
  (defconstant SQL_ISV_CONSTRAINT_COLUMN_USAGE 0x00000080L)
  (defconstant SQL_ISV_CONSTRAINT_TABLE_USAGE 0x00000100L)
  (defconstant SQL_ISV_DOMAIN_CONSTRAINTS 0x00000200L)
  (defconstant SQL_ISV_DOMAINS 0x00000400L)
  (defconstant SQL_ISV_KEY_COLUMN_USAGE 0x00000800L)
  (defconstant SQL_ISV_REFERENTIAL_CONSTRAINTS 0x00001000L)
  (defconstant SQL_ISV_SCHEMATA 0x00002000L)
  (defconstant SQL_ISV_SQL_LANGUAGES 0x00004000L)
  (defconstant SQL_ISV_TABLE_CONSTRAINTS 0x00008000L)
  (defconstant SQL_ISV_TABLE_PRIVILEGES 0x00010000L)
  (defconstant SQL_ISV_TABLES 0x00020000L)
  (defconstant SQL_ISV_TRANSLATIONS 0x00040000L)
  (defconstant SQL_ISV_USAGE_PRIVILEGES 0x00080000L)
  (defconstant SQL_ISV_VIEW_COLUMN_USAGE 0x00100000L)
  (defconstant SQL_ISV_VIEW_TABLE_USAGE 0x00200000L)
  (defconstant SQL_ISV_VIEWS 0x00400000L)
...
;;;;** Bitmasks for SQL_ALTER_DOMAIN
  (defconstant SQL_AD_CONSTRAINT_NAME_DEFINITION 0x00000001L)
  (defconstant SQL_AD_ADD_DOMAIN_CONSTRAINT 0x00000002L)
  (defconstant SQL_AD_DROP_DOMAIN_CONSTRAINT 0x00000004L)
  (defconstant SQL_AD_ADD_DOMAIN_DEFAULT 0x00000008L)
  (defconstant SQL_AD_DROP_DOMAIN_DEFAULT 0x00000010L)
  (defconstant SQL_AD_ADD_CONSTRAINT_INITIALLY_DEFERRED 0x00000020L)
  (defconstant SQL_AD_ADD_CONSTRAINT_INITIALLY_IMMEDIATE 0x00000040L)
  (defconstant SQL_AD_ADD_CONSTRAINT_DEFERRABLE 0x00000080L)
  (defconstant SQL_AD_ADD_CONSTRAINT_NON_DEFERRABLE 0x00000100L)

;;;;** SQL_CREATE_SCHEMA bitmasks
  (defconstant SQL_CS_CREATE_SCHEMA 0x00000001L)
  (defconstant SQL_CS_AUTHORIZATION 0x00000002L)
  (defconstant SQL_CS_DEFAULT_CHARACTER_SET 0x00000004L)

;;;;** SQL_CREATE_TRANSLATION bitmasks
  (defconstant SQL_CTR_CREATE_TRANSLATION 0x00000001L)

;;;;** SQL_CREATE_ASSERTION bitmasks
  (defconstant SQL_CA_CREATE_ASSERTION 0x00000001L)
  (defconstant SQL_CA_CONSTRAINT_INITIALLY_DEFERRED 0x00000010L)
  (defconstant SQL_CA_CONSTRAINT_INITIALLY_IMMEDIATE 0x00000020L)
  (defconstant SQL_CA_CONSTRAINT_DEFERRABLE 0x00000040L)
  (defconstant SQL_CA_CONSTRAINT_NON_DEFERRABLE 0x00000080L)

;;;;** SQL_CREATE_CHARACTER_SET bitmasks
  (defconstant SQL_CCS_CREATE_CHARACTER_SET 0x00000001L)
  (defconstant SQL_CCS_COLLATE_CLAUSE 0x00000002L)
  (defconstant SQL_CCS_LIMITED_COLLATION 0x00000004L)

;;;;** SQL_CREATE_COLLATION bitmasks
  (defconstant SQL_CCOL_CREATE_COLLATION 0x00000001L)

;;;;** SQL_CREATE_DOMAIN bitmasks
  (defconstant SQL_CDO_CREATE_DOMAIN 0x00000001L)
  (defconstant SQL_CDO_DEFAULT 0x00000002L)
  (defconstant SQL_CDO_CONSTRAINT 0x00000004L)
  (defconstant SQL_CDO_COLLATION 0x00000008L)
  (defconstant SQL_CDO_CONSTRAINT_NAME_DEFINITION 0x00000010L)
  (defconstant SQL_CDO_CONSTRAINT_INITIALLY_DEFERRED 0x00000020L)
  (defconstant SQL_CDO_CONSTRAINT_INITIALLY_IMMEDIATE 0x00000040L)
  (defconstant SQL_CDO_CONSTRAINT_DEFERRABLE 0x00000080L)
  (defconstant SQL_CDO_CONSTRAINT_NON_DEFERRABLE 0x00000100L)

;;;;** SQL_CREATE_TABLE bitmasks
  (defconstant SQL_CT_CREATE_TABLE 0x00000001L)
  (defconstant SQL_CT_COMMIT_PRESERVE 0x00000002L)
  (defconstant SQL_CT_COMMIT_DELETE 0x00000004L)
  (defconstant SQL_CT_GLOBAL_TEMPORARY 0x00000008L)
  (defconstant SQL_CT_LOCAL_TEMPORARY 0x00000010L)
  (defconstant SQL_CT_CONSTRAINT_INITIALLY_DEFERRED 0x00000020L)
  (defconstant SQL_CT_CONSTRAINT_INITIALLY_IMMEDIATE 0x00000040L)
  (defconstant SQL_CT_CONSTRAINT_DEFERRABLE 0x00000080L)
  (defconstant SQL_CT_CONSTRAINT_NON_DEFERRABLE 0x00000100L)
  (defconstant SQL_CT_COLUMN_CONSTRAINT 0x00000200L)
  (defconstant SQL_CT_COLUMN_DEFAULT 0x00000400L)
  (defconstant SQL_CT_COLUMN_COLLATION 0x00000800L)
  (defconstant SQL_CT_TABLE_CONSTRAINT 0x00001000L)
  (defconstant SQL_CT_CONSTRAINT_NAME_DEFINITION 0x00002000L)

;;;;** SQL_DDL_INDEX bitmasks
  (defconstant SQL_DI_CREATE_INDEX 0x00000001L)
  (defconstant SQL_DI_DROP_INDEX 0x00000002L)

;;;;** SQL_DROP_COLLATION bitmasks
  (defconstant SQL_DC_DROP_COLLATION 0x00000001L)

;;;;** SQL_DROP_DOMAIN bitmasks
  (defconstant SQL_DD_DROP_DOMAIN 0x00000001L)
  (defconstant SQL_DD_RESTRICT 0x00000002L)
  (defconstant SQL_DD_CASCADE 0x00000004L)

;;;;** SQL_DROP_SCHEMA bitmasks
  (defconstant SQL_DS_DROP_SCHEMA 0x00000001L)
  (defconstant SQL_DS_RESTRICT 0x00000002L)
  (defconstant SQL_DS_CASCADE 0x00000004L)

;;;;** SQL_DROP_CHARACTER_SET bitmasks
  (defconstant SQL_DCS_DROP_CHARACTER_SET 0x00000001L)

;;;;** SQL_DROP_ASSERTION bitmasks
  (defconstant SQL_DA_DROP_ASSERTION 0x00000001L)

;;;;** SQL_DROP_TABLE bitmasks
  (defconstant SQL_DT_DROP_TABLE 0x00000001L)
  (defconstant SQL_DT_RESTRICT 0x00000002L)
  (defconstant SQL_DT_CASCADE 0x00000004L)

;;;;** SQL_DROP_TRANSLATION bitmasks
  (defconstant SQL_DTR_DROP_TRANSLATION 0x00000001L)

;;;;** SQL_DROP_VIEW bitmasks
  (defconstant SQL_DV_DROP_VIEW 0x00000001L)
  (defconstant SQL_DV_RESTRICT 0x00000002L)
  (defconstant SQL_DV_CASCADE 0x00000004L)

;;;;** SQL_INSERT_STATEMENT bitmasks
  (defconstant SQL_IS_INSERT_LITERALS 0x00000001L)
  (defconstant SQL_IS_INSERT_SEARCHED 0x00000002L)
  (defconstant SQL_IS_SELECT_INTO 0x00000004L)

;;;;** SQL_ODBC_INTERFACE_CONFORMANCE values
  (defconstant SQL_OIC_CORE 1UL)
  (defconstant SQL_OIC_LEVEL1 2UL)
  (defconstant SQL_OIC_LEVEL2 3UL)

;;;;** SQL_SQL92_FOREIGN_KEY_DELETE_RULE bitmasks
  (defconstant SQL_SFKD_CASCADE 0x00000001L)
  (defconstant SQL_SFKD_NO_ACTION 0x00000002L)
  (defconstant SQL_SFKD_SET_DEFAULT 0x00000004L)
  (defconstant SQL_SFKD_SET_NULL 0x00000008L)

;;;;** SQL_SQL92_FOREIGN_KEY_UPDATE_RULE bitmasks
  (defconstant SQL_SFKU_CASCADE 0x00000001L)
  (defconstant SQL_SFKU_NO_ACTION 0x00000002L)
  (defconstant SQL_SFKU_SET_DEFAULT 0x00000004L)
  (defconstant SQL_SFKU_SET_NULL 0x00000008L)

;;;;** SQL_SQL92_GRANT  bitmasks
  (defconstant SQL_SG_USAGE_ON_DOMAIN 0x00000001L)
  (defconstant SQL_SG_USAGE_ON_CHARACTER_SET 0x00000002L)
  (defconstant SQL_SG_USAGE_ON_COLLATION 0x00000004L)
  (defconstant SQL_SG_USAGE_ON_TRANSLATION 0x00000008L)
  (defconstant SQL_SG_WITH_GRANT_OPTION 0x00000010L)
  (defconstant SQL_SG_DELETE_TABLE 0x00000020L)
  (defconstant SQL_SG_INSERT_TABLE 0x00000040L)
  (defconstant SQL_SG_INSERT_COLUMN 0x00000080L)
  (defconstant SQL_SG_REFERENCES_TABLE 0x00000100L)
  (defconstant SQL_SG_REFERENCES_COLUMN 0x00000200L)
  (defconstant SQL_SG_SELECT_TABLE 0x00000400L)
  (defconstant SQL_SG_UPDATE_TABLE 0x00000800L)
  (defconstant SQL_SG_UPDATE_COLUMN 0x00001000L)

;;;;** SQL_SQL92_PREDICATES bitmasks
  (defconstant SQL_SP_EXISTS 0x00000001L)
  (defconstant SQL_SP_ISNOTNULL 0x00000002L)
  (defconstant SQL_SP_ISNULL 0x00000004L)
  (defconstant SQL_SP_MATCH_FULL 0x00000008L)
  (defconstant SQL_SP_MATCH_PARTIAL 0x00000010L)
  (defconstant SQL_SP_MATCH_UNIQUE_FULL 0x00000020L)
  (defconstant SQL_SP_MATCH_UNIQUE_PARTIAL 0x00000040L)
  (defconstant SQL_SP_OVERLAPS 0x00000080L)
  (defconstant SQL_SP_UNIQUE 0x00000100L)
  (defconstant SQL_SP_LIKE 0x00000200L)
  (defconstant SQL_SP_IN 0x00000400L)
  (defconstant SQL_SP_BETWEEN 0x00000800L)
  (defconstant SQL_SP_COMPARISON 0x00001000L)
  (defconstant SQL_SP_QUANTIFIED_COMPARISON 0x00002000L)

;;;;** SQL_SQL92_RELATIONAL_JOIN_OPERATORS bitmasks
  (defconstant SQL_SRJO_CORRESPONDING_CLAUSE 0x00000001L)
  (defconstant SQL_SRJO_CROSS_JOIN 0x00000002L)
  (defconstant SQL_SRJO_EXCEPT_JOIN 0x00000004L)
  (defconstant SQL_SRJO_FULL_OUTER_JOIN 0x00000008L)
  (defconstant SQL_SRJO_INNER_JOIN 0x00000010L)
  (defconstant SQL_SRJO_INTERSECT_JOIN 0x00000020L)
  (defconstant SQL_SRJO_LEFT_OUTER_JOIN 0x00000040L)
  (defconstant SQL_SRJO_NATURAL_JOIN 0x00000080L)
  (defconstant SQL_SRJO_RIGHT_OUTER_JOIN 0x00000100L)
  (defconstant SQL_SRJO_UNION_JOIN 0x00000200L)

;;;;** SQL_SQL92_REVOKE bitmasks
  (defconstant SQL_SR_USAGE_ON_DOMAIN 0x00000001L)
  (defconstant SQL_SR_USAGE_ON_CHARACTER_SET 0x00000002L)
  (defconstant SQL_SR_USAGE_ON_COLLATION 0x00000004L)
  (defconstant SQL_SR_USAGE_ON_TRANSLATION 0x00000008L)
  (defconstant SQL_SR_GRANT_OPTION_FOR 0x00000010L)
  (defconstant SQL_SR_CASCADE 0x00000020L)
  (defconstant SQL_SR_RESTRICT 0x00000040L)
  (defconstant SQL_SR_DELETE_TABLE 0x00000080L)
  (defconstant SQL_SR_INSERT_TABLE 0x00000100L)
  (defconstant SQL_SR_INSERT_COLUMN 0x00000200L)
  (defconstant SQL_SR_REFERENCES_TABLE 0x00000400L)
  (defconstant SQL_SR_REFERENCES_COLUMN 0x00000800L)
  (defconstant SQL_SR_SELECT_TABLE 0x00001000L)
  (defconstant SQL_SR_UPDATE_TABLE 0x00002000L)
  (defconstant SQL_SR_UPDATE_COLUMN 0x00004000L)

;;;;** SQL_SQL92_ROW_VALUE_CONSTRUCTOR bitmasks
  (defconstant SQL_SRVC_VALUE_EXPRESSION 0x00000001L)
  (defconstant SQL_SRVC_NULL 0x00000002L)
  (defconstant SQL_SRVC_DEFAULT 0x00000004L)
  (defconstant SQL_SRVC_ROW_SUBQUERY 0x00000008L)

;;;;** SQL_SQL92_VALUE_EXPRESSIONS bitmasks
  (defconstant SQL_SVE_CASE 0x00000001L)
  (defconstant SQL_SVE_CAST 0x00000002L)
  (defconstant SQL_SVE_COALESCE 0x00000004L)
  (defconstant SQL_SVE_NULLIF 0x00000008L)

;;;;** SQL_STANDARD_CLI_CONFORMANCE bitmasks
  (defconstant SQL_SCC_XOPEN_CLI_VERSION1 0x00000001L)
  (defconstant SQL_SCC_ISO92_CLI 0x00000002L)
...
(defconstant SQL_DTC_ENLIST_EXPENSIVE 0x00000001L)
(defconstant SQL_DTC_UNENLIST_EXPENSIVE 0x00000002L)

#-odbc2
(progn
;;;;** Possible values for SQL_ASYNC_DBC_FUNCTIONS 
  (defconstant SQL_ASYNC_DBC_NOT_CAPABLE 0x00000000L)
  (defconstant SQL_ASYNC_DBC_CAPABLE 0x00000001L)
